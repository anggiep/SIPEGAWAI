...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Jabatan</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form id="jabatan-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("jabatan/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="nm_jabatan">Nm Jabatan <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nm_jabatan"  value="<?php  echo $this->set_field_value('nm_jabatan',""); ?>" type="text" placeholder="Enter Nm Jabatan"  required="" name="nm_jabatan"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-gaji_pokok"  value="<?php  echo $this->set_field_value('gaji_pokok',""); ?>" type="number" placeholder="Enter Gaji Pokok" step="1"  required="" name="gaji_pokok"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
