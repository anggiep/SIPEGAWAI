                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-nm_jabatan"> Nm Jabatan</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("jabatan/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-nm_jabatan">
                                                        <span  data-value="<?php echo $data['nm_jabatan']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("jabatan/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="nm_jabatan" 
                                                            data-title="Enter Nm Jabatan" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
