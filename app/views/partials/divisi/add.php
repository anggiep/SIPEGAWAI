                        ...
                        <form id="divisi-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("divisi/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="nm_divisi">Nm Divisi <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nm_divisi"  value="<?php  echo $this->set_field_value('nm_divisi',""); ?>" type="text" placeholder="Enter Nm Divisi"  required="" name="nm_divisi"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
