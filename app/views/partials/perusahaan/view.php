                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-email_public">
                                        <th class="title"> Email Public: </th>
                                        <td class="value">
                                            <span  data-value="<?php echo $data['email_public']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("perusahaan/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="email_public" 
                                                data-title="Enter Email Public" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="email" 
                                                data-mode="popover" 
                                                data-showbuttons="left" 
                                                class="is-editable" >
                                                <?php echo $data['email_public']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    <tr  class="td-path_logo">
                                        <th class="title"> Path Logo: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-email_private">
                                        <th class="title"> Email Private: </th>
                                        <td class="value">
                                            <span  data-value="<?php echo $data['email_private']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("perusahaan/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="email_private" 
                                                data-title="Enter Email Private" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="email" 
                                                data-mode="popover" 
