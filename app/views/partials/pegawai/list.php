                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-alamat_ktp"> Alamat Ktp</th>
                                                <th  class="td-alamat_dom"> Alamat Dom</th>
                                                <th  class="td-status"> Status</th>
                                                <th  class="td-jml_anak"> Jml Anak</th>
                                                <th  class="td-no_hp"> No Hp</th>
                                                <th  class="td-email"> Email</th>
                                                <th  class="td-password"> Password</th>
                                                <th  class="td-tgl_masuk"> Tgl Masuk</th>
                                                <th  class="td-id_atasan"> Id Atasan</th>
