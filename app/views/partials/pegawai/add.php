                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-agama"  value="<?php  echo $this->set_field_value('agama',""); ?>" type="text" placeholder="Enter Agama"  required="" name="agama"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-alamat_ktp"  value="<?php  echo $this->set_field_value('alamat_ktp',""); ?>" type="text" placeholder="Enter Alamat Ktp"  required="" name="alamat_ktp"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-alamat_dom"  value="<?php  echo $this->set_field_value('alamat_dom',""); ?>" type="text" placeholder="Enter Alamat Dom"  required="" name="alamat_dom"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-jml_anak"  value="<?php  echo $this->set_field_value('jml_anak',""); ?>" type="number" placeholder="Enter Jml Anak" step="1"  required="" name="jml_anak"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-8">
                                                                                                    <div class="">
                                                                                                        <input id="ctrl-id_atasan"  value="<?php  echo $this->set_field_value('id_atasan',""); ?>" type="number" placeholder="Enter Id Atasan" step="1"  required="" name="id_atasan"  class="form-control " />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group ">
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-sm-8">
                                                                                                        <div class="">
                                                                                                            <input id="ctrl-id_jabatan"  value="<?php  echo $this->set_field_value('id_jabatan',""); ?>" type="number" placeholder="Enter Id Jabatan" step="1"  required="" name="id_jabatan"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="form-group ">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-sm-8">
                                                                                                            <div class="">
                                                                                                                <input id="ctrl-id_divisi"  value="<?php  echo $this->set_field_value('id_divisi',""); ?>" type="number" placeholder="Enter Id Divisi" step="1"  required="" name="id_divisi"  class="form-control " />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
